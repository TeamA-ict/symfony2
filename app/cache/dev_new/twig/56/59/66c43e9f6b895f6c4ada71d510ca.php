...
class __TwigTemplate_565966c43e9f6b895f6c4ada71d510ca extends Twig_Template
{
    ...
    <tbody>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["key"]) {
            ...
            if (isset($context["bag"])) { $_bag_ = $context["bag"]; } else { $_bag_ = null; }
            if (isset($context["key"])) { $_key_ = $context["key"]; } else { $_key_ = null; }
            echo twig_escape_filter($this->env, $this->env->getExtension('yaml')->dump($this->getAttribute($_bag_, "get", array(0 => $_key_), "method")), "html", null, true);
            echo "</td>
        </tr>
        ";
        }
